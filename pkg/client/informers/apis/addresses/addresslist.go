...
import (
	...
	apisaddresses "github.com/fire833/vroute/pkg/apis/addresses"
	clientset "github.com/fire833/vroute/pkg/client/clientset"
	addresses "github.com/fire833/vroute/pkg/client/listers/apis/addresses"
...
type AddressListInformer interface {
	...
	Lister() addresses.AddressListLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AddressesAddresses().AddressLists(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AddressesAddresses().AddressLists(namespace).Watch(context.TODO(), options)
			},
		},
		&apisaddresses.AddressList{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *addressListInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisaddresses.AddressList{}, f.defaultInformer)
}

func (f *addressListInformer) Lister() addresses.AddressListLister {
	return addresses.NewAddressListLister(f.Informer().GetIndexer())
}
