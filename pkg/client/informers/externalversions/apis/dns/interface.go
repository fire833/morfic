...
func (v *version) DNSProviders() DNSProviderInformer {
	return &dNSProviderInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}

// DNSProviderLists returns a DNSProviderListInformer.
func (v *version) DNSProviderLists() DNSProviderListInformer {
	return &dNSProviderListInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
...
func (v *version) DNSRecordLists() DNSRecordListInformer {
	return &dNSRecordListInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
