...
func (f *addressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisnet.Address{}, f.defaultInformer)
}

func (f *addressInformer) Lister() net.AddressLister {
	return net.NewAddressLister(f.Informer().GetIndexer())
}
