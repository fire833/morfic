...
type LinkListInterface interface {
	Create(ctx context.Context, linkList *interfaces.LinkList, opts v1.CreateOptions) (*interfaces.LinkList, error)
	Update(ctx context.Context, linkList *interfaces.LinkList, opts v1.UpdateOptions) (*interfaces.LinkList, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*interfaces.LinkList, error)
	List(ctx context.Context, opts v1.ListOptions) (*interfaces.LinkListList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *interfaces.LinkList, err error)
	LinkListExpansion
}
...
func newLinkLists(c *InterfacesClient, namespace string) *linkLists {
	return &linkLists{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *linkLists) Get(ctx context.Context, name string, options v1.GetOptions) (result *interfaces.LinkList, err error) {
	result = &interfaces.LinkList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("linklists").
		Name(name).
...
func (c *linkLists) List(ctx context.Context, opts v1.ListOptions) (result *interfaces.LinkListList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &interfaces.LinkListList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("linklists").
...
func (c *linkLists) Create(ctx context.Context, linkList *interfaces.LinkList, opts v1.CreateOptions) (result *interfaces.LinkList, err error) {
	result = &interfaces.LinkList{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("linklists").
...
func (c *linkLists) Update(ctx context.Context, linkList *interfaces.LinkList, opts v1.UpdateOptions) (result *interfaces.LinkList, err error) {
	result = &interfaces.LinkList{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("linklists").
...
func (c *linkLists) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *interfaces.LinkList, err error) {
	result = &interfaces.LinkList{}
