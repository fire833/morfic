...
type RouteTableListInterface interface {
	Create(ctx context.Context, routeTableList *routes.RouteTableList, opts v1.CreateOptions) (*routes.RouteTableList, error)
	Update(ctx context.Context, routeTableList *routes.RouteTableList, opts v1.UpdateOptions) (*routes.RouteTableList, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*routes.RouteTableList, error)
	List(ctx context.Context, opts v1.ListOptions) (*routes.RouteTableListList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *routes.RouteTableList, err error)
...
func newRouteTableLists(c *RoutesClient, namespace string) *routeTableLists {
...
func (c *routeTableLists) Get(ctx context.Context, name string, options v1.GetOptions) (result *routes.RouteTableList, err error) {
	result = &routes.RouteTableList{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *routeTableLists) List(ctx context.Context, opts v1.ListOptions) (result *routes.RouteTableListList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &routes.RouteTableListList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("routetablelists").
...
func (c *routeTableLists) Create(ctx context.Context, routeTableList *routes.RouteTableList, opts v1.CreateOptions) (result *routes.RouteTableList, err error) {
	result = &routes.RouteTableList{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("routetablelists").
...
func (c *routeTableLists) Update(ctx context.Context, routeTableList *routes.RouteTableList, opts v1.UpdateOptions) (result *routes.RouteTableList, err error) {
	result = &routes.RouteTableList{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routetablelists").
...
func (c *routeTableLists) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *routes.RouteTableList, err error) {
	result = &routes.RouteTableList{}
