...
// AuthenticationClient is used to interact with features provided by the authentication.morfic.io group.
...
func setConfigDefaults(config *rest.Config) error {
	...
	if config.GroupVersion == nil || config.GroupVersion.Group != scheme.Scheme.PrioritizedVersionsForGroup("authentication.morfic.io")[0].Group {
		gv := scheme.Scheme.PrioritizedVersionsForGroup("authentication.morfic.io")[0]
