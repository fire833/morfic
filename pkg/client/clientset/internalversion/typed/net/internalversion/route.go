...
type RouteInterface interface {
	Create(ctx context.Context, route *net.Route, opts v1.CreateOptions) (*net.Route, error)
	Update(ctx context.Context, route *net.Route, opts v1.UpdateOptions) (*net.Route, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*net.Route, error)
	List(ctx context.Context, opts v1.ListOptions) (*net.RouteList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *net.Route, err error)
	RouteExpansion
}
...
func newRoutes(c *NetClient, namespace string) *routes {
	return &routes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *routes) Get(ctx context.Context, name string, options v1.GetOptions) (result *net.Route, err error) {
	result = &net.Route{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) List(ctx context.Context, opts v1.ListOptions) (result *net.RouteList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &net.RouteList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) Create(ctx context.Context, route *net.Route, opts v1.CreateOptions) (result *net.Route, err error) {
	result = &net.Route{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) Update(ctx context.Context, route *net.Route, opts v1.UpdateOptions) (result *net.Route, err error) {
	result = &net.Route{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *net.Route, err error) {
	result = &net.Route{}
