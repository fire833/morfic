...
type NeighborListInterface interface {
	Create(ctx context.Context, neighborList *net.NeighborList, opts v1.CreateOptions) (*net.NeighborList, error)
	Update(ctx context.Context, neighborList *net.NeighborList, opts v1.UpdateOptions) (*net.NeighborList, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*net.NeighborList, error)
	List(ctx context.Context, opts v1.ListOptions) (*net.NeighborListList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *net.NeighborList, err error)
...
func newNeighborLists(c *NetClient, namespace string) *neighborLists {
...
func (c *neighborLists) Get(ctx context.Context, name string, options v1.GetOptions) (result *net.NeighborList, err error) {
...
func (c *neighborLists) List(ctx context.Context, opts v1.ListOptions) (result *net.NeighborListList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &net.NeighborListList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("neighborlists").
...
func (c *neighborLists) Create(ctx context.Context, neighborList *net.NeighborList, opts v1.CreateOptions) (result *net.NeighborList, err error) {
	result = &net.NeighborList{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("neighborlists").
...
func (c *neighborLists) Update(ctx context.Context, neighborList *net.NeighborList, opts v1.UpdateOptions) (result *net.NeighborList, err error) {
	result = &net.NeighborList{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("neighborlists").
...
func (c *neighborLists) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *net.NeighborList, err error) {
	result = &net.NeighborList{}
