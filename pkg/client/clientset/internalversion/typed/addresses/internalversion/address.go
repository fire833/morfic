...
type AddressInterface interface {
	Create(ctx context.Context, address *addresses.Address, opts v1.CreateOptions) (*addresses.Address, error)
	Update(ctx context.Context, address *addresses.Address, opts v1.UpdateOptions) (*addresses.Address, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*addresses.Address, error)
	List(ctx context.Context, opts v1.ListOptions) (*addresses.AddressList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *addresses.Address, err error)
	AddressExpansion
}
...
func newAddresses(c *AddressesClient, namespace string) *addresses {
	return &addresses{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *addresses) Get(ctx context.Context, name string, options v1.GetOptions) (result *addresses.Address, err error) {
...
func (c *addresses) List(ctx context.Context, opts v1.ListOptions) (result *addresses.AddressList, err error) {
...
func (c *addresses) Create(ctx context.Context, address *addresses.Address, opts v1.CreateOptions) (result *addresses.Address, err error) {
	result = &addresses.Address{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("addresses").
...
func (c *addresses) Update(ctx context.Context, address *addresses.Address, opts v1.UpdateOptions) (result *addresses.Address, err error) {
	result = &addresses.Address{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("addresses").
...
func (c *addresses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *addresses.Address, err error) {
	result = &addresses.Address{}
