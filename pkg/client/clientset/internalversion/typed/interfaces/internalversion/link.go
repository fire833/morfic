...
type LinkInterface interface {
	Create(ctx context.Context, link *interfaces.Link, opts v1.CreateOptions) (*interfaces.Link, error)
	Update(ctx context.Context, link *interfaces.Link, opts v1.UpdateOptions) (*interfaces.Link, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*interfaces.Link, error)
	List(ctx context.Context, opts v1.ListOptions) (*interfaces.LinkList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *interfaces.Link, err error)
	LinkExpansion
}
...
func newLinks(c *InterfacesClient, namespace string) *links {
	return &links{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *links) Get(ctx context.Context, name string, options v1.GetOptions) (result *interfaces.Link, err error) {
	result = &interfaces.Link{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("links").
		Name(name).
...
func (c *links) List(ctx context.Context, opts v1.ListOptions) (result *interfaces.LinkList, err error) {
...
func (c *links) Create(ctx context.Context, link *interfaces.Link, opts v1.CreateOptions) (result *interfaces.Link, err error) {
	result = &interfaces.Link{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("links").
...
func (c *links) Update(ctx context.Context, link *interfaces.Link, opts v1.UpdateOptions) (result *interfaces.Link, err error) {
	result = &interfaces.Link{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("links").
...
func (c *links) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *interfaces.Link, err error) {
	result = &interfaces.Link{}
