...
type TableInterface interface {
	Create(ctx context.Context, table *firewall.Table, opts v1.CreateOptions) (*firewall.Table, error)
	Update(ctx context.Context, table *firewall.Table, opts v1.UpdateOptions) (*firewall.Table, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*firewall.Table, error)
	List(ctx context.Context, opts v1.ListOptions) (*firewall.TableList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *firewall.Table, err error)
	TableExpansion
}
...
func newTables(c *FirewallClient, namespace string) *tables {
	return &tables{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tables) Get(ctx context.Context, name string, options v1.GetOptions) (result *firewall.Table, err error) {
	result = &firewall.Table{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tables").
		Name(name).
...
func (c *tables) List(ctx context.Context, opts v1.ListOptions) (result *firewall.TableList, err error) {
...
func (c *tables) Create(ctx context.Context, table *firewall.Table, opts v1.CreateOptions) (result *firewall.Table, err error) {
	result = &firewall.Table{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tables").
...
func (c *tables) Update(ctx context.Context, table *firewall.Table, opts v1.UpdateOptions) (result *firewall.Table, err error) {
	result = &firewall.Table{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tables").
...
func (c *tables) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *firewall.Table, err error) {
	result = &firewall.Table{}
