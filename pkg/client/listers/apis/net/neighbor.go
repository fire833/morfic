...
// List lists all Neighbors in the indexer for a given namespace.
func (s neighborNamespaceLister) List(selector labels.Selector) (ret []*net.Neighbor, err error) {
...
// Get retrieves the Neighbor from the indexer for a given namespace and name.
func (s neighborNamespaceLister) Get(name string) (*net.Neighbor, error) {
